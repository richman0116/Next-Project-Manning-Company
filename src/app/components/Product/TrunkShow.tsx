    ...
    <Wrapper>
      <div className="bg-[#F9F9F9] md:pt-[270px] pt-[150px] flex flex-col justify-center items-center"  >
        <div className="pt-[50px]">
          ...
          <div className="flex flex-col items-center justify-center gap-2 pt-[60px] px-3">
        ...
        <div className="pt-[100px] grid grid-cols-2 grid-rows-5 lg:grid-cols-5 lg:grid-rows-2 gap-4">
          {
