          ...
          <div className="absolute w-full h-[447px] md:h-[753px] bg-[#00000066] bg-opacity-80">
            <div className="md:px-16 md:pt-72 text-white pt-52  bg-opacity-40  flex flex-col md:items-start items-center  sm:px-4">
              ...
              <p className=" text-center ">
                <span className="font-SaolDisplayR md:leading-[38px] text-[28px] md:text-[60px]  leading-[3px] Crafted">
                  Crafted
                </span>
                <span className="font-SaolDisplay md:leading-[38px] text-[28px] md:text-[60px]  leading-[3px] WithCare">
                  With Care
                </span>
              </p>
