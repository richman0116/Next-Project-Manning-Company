...
const Footer  = () => {
    return (
        ...
        <div className="bg-[#000000] max-container mt-10">
            ...
            <div className="flex flex-col gap-1 text-white flexCenter pt-6 ">
              ...
              <div className="p-5 ">
                ...
                <div className="">
                    <div className="p-10 w-full">
                        <h1 className='">Custom Suit Hong Kong</Link>
                '>Newsletter</h1>
                        ...
                        <div className='flex flex-col pt-4 justify-center'>
                            ...
                            <button className='flexCenter  text-white font-Akzidenz'>Subscribe</button>
                            <div className='flex gap-2 flexCenter pt-8'>
                                <input type="checkbox" className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"/>
                                <label className="text-sm text-white footer font-Akzidenz">I have read and agreed with the <Link href={''} className='relative'>Privacy Policy<div className="absolute left-0 right-0 bottom-0 h-0.5 bg-white"></div></Link></label>
                            </div>
                        </div>
                    </div>
                    {/* Contact information */}
                    <div className='flex lg:flex-row p-4 w-full flex-col md:flex-row text-white pt-6 gap-4'>
                        ...
                        <div className='flex  gap-3  '>
                            ...
                            <p className='font-Akzidenz'>Shop 22B, G/F., Hankow Centre,<br/>5-15 Hankow Road Tsim Sha Tsui,<br/>Kowloon Hong Kong</p>
                        </div>
                    </div>
                </div>
            </div>
